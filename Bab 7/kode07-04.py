...
NEXUS_BootstrapTrees_file = r"%s\FILOGENI\UPGMA\BTSTRP COX1 Bovines DNA.nexus" % (dir_kerja)
NEWICK_Tree_file = r"%s\FILOGENI\UPGMA\COX1 Bovines DNA.nwk" % (dir_kerja)
...
PAUP_block = """\
    begin paup;
      ...
      dset distance=P;
      bootstrap search=UPGMA nreps=1000 conlevel=50 brlens=yes treefile='%s' format=Nexus;
    end
""" % (NEXUS_dir, NEXUS_file, NEXUS_BootstrapTrees_file)
