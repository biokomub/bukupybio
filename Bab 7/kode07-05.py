...
NEXUS_BootstrapTrees_file = r"%s\FILOGENI\MP\BTSTRP COX1 Bovines DNA.nexus" % (dir_kerja)
NEWICK_Tree_file = r"%s\FILOGENI\MP\COX1 Bovines DNA.nwk" % (dir_kerja)
...
""" % (NEXUS_dir, NEXUS_file, outgroup, NEXUS_BootstrapTrees_file)
