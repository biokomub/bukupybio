...
NEXUS_BootstrapTrees_file = r"%s\FILOGENI\ME\BTSTRP COX1 Bovines DNA.nexus" % (dir_kerja)
NEWICK_Tree_file = r"%s\FILOGENI\ME\COX1 Bovines DNA.nwk" % (dir_kerja)
...
PAUP_block = """\
    begin paup;
      ...
      bootstrap search=heuristic nreps=1000 conlevel=50 treefile='%s' format=Nexus /start=stepwise swap=NNI;
    end
